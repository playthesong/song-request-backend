...
import live.playthesong.songrequest.domain.letter.request.LetterRequestBuilder;
import live.playthesong.songrequest.domain.letter.request.StatusChangeRequest;
import live.playthesong.songrequest.domain.letter.request.StatusChangeRequestBuilder;
...
public class LetterFactory {
    ...
    public static Page<Letter> createLettersPage() {
        return new PageImpl<>(createLettersOf(createMember(), SongFactory.createSong()));
    }
